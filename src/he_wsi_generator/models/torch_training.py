...
def _sampled_style_policy_summary(value: Any) -> dict[str, Any]:
    if not isinstance(value, dict):
        raise TorchTrainingError("condition packet conditions.style_seed must be an object")
...
def _sampled_texture_policy_summary(value: Any) -> dict[str, Any]:
    if not isinstance(value, dict):
        raise TorchTrainingError("condition packet conditions.texture_token must be an object")
    return {
